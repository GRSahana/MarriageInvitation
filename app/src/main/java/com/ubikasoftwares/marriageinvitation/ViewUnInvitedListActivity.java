...
public class ViewUnInvitedListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_un_invited_list);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Intent back = new Intent(ViewUnInvitedListActivity.this,ViewUnInvitedListActivity.class);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent back = new Intent(ViewUnInvitedListActivity.this,Main2Activity.class);
                back.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                back.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                back.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(back);
        ...
        search = (EditText)findViewById(R.id.searchUnInvited);

        recyclerView = findViewById(R.id.viewUnInvited);
    ...
    private void loadListDetails() {
        ...
        ViewInvitees viewInvitees = new ViewInvitees("viewInviteesNotInvited",params);
                        ...
                        if (jsonObject.has("response")) {
                            ...
                            if (success) {
                                if (Status.equals("200")) {
                                    ...
                                    inviteesAdapter = new InviteesAdapter(ViewUnInvitedListActivity.this,inviteesDetails, Config.ACTIVITY_3);
...
//                                    recyclerView.setAdapter(attendanceAdapter);
                                    ...
                                    Toast.makeText(ViewUnInvitedListActivity.this, "No Students are there!!", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(ViewUnInvitedListActivity.this, "Error!!", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(ViewUnInvitedListActivity.this, "Error!!", Toast.LENGTH_SHORT).show();
                        }
            ...
            public void onFailure(@NonNull Call<ResponseBody> call, @NonNull Throwable t) {
                ...
                Toast.makeText(ViewUnInvitedListActivity.this, "Internet Error!!", Toast.LENGTH_SHORT).show();
