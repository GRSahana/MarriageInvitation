...
public class ViewInvitedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_invited);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent back = new Intent(ViewInvitedActivity.this,Main2Activity.class);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                Intent back = new Intent(ViewInvitedActivity.this,ViewInvitedActivity.class);
                back.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                back.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                back.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(back);
        ...
        search = (EditText)findViewById(R.id.searchInvited);


        recyclerView = findViewById(R.id.viewInvited);
    ...
    private void loadListDetails() {
        ...
        ViewInvitees viewInvitees = new ViewInvitees("viewInviteesInvited",params);
                        ...
                        if (jsonObject.has("response")) {
                            ...
                            if (success) {
                                if (Status.equals("200")) {
                                    ...
                                    inviteesAdapter = new InviteesAdapter(ViewInvitedActivity.this,inviteesDetails, Config.ACTIVITY_2);
...
//                                    recyclerView.setAdapter(attendanceAdapter);
                                    ...
                                    Toast.makeText(ViewInvitedActivity.this, "No Students are there!!", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(ViewInvitedActivity.this, "Error!!", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(ViewInvitedActivity.this, "Error!!", Toast.LENGTH_SHORT).show();
                        }
            ...
            public void onFailure(@NonNull Call<ResponseBody> call, @NonNull Throwable t) {
                ...
                Toast.makeText(ViewInvitedActivity.this, "Internet Error!!", Toast.LENGTH_SHORT).show();
